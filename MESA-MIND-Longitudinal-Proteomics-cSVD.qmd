...
# Cross sectional Protein-Wide Association Studies (PWAS)

```{r}
#| label: cross-sectional PWAS
...
-   The E6 proteins -\> E6 MRI for WMH included data from N=`{r} print(max(PWAS_res$WMH_E6_nobs, na.rm=TRUE))` participants.
